...
# 1 # Merges training and test tabels for the sets, activity labels and subjects.
      # sets
...
# 2 # Extracts mean and standard deviation measurements from set, converts activities labels into factors and merge 
      # subject ids with activities and set (for mean and std only, meanFreq are treated as mean variables)
